...
const PROJECTS = [
  ...
  {
    slug: "nido", category: "product", year: "2025", has3d: false, mainAspect: "1100/619", mainUnframed: true, wideSrc: "uploads/nido-elephant-views.webp", wideAspect: "7/6", wideHeight: "210px", rot: "1deg",
    title: "Nido",
    tag: { en: "Family of products", es: "Familia de productos" },
    oneLine: {
...
const T = {
  ...
  bio: {
    ...
    es: "Soy <b>Daniela García</b>, diseñadora industrial basada en México. Soy creadora de objetos que equilibran una empatía genuina hacia el usuario con intención estética, aportando un elemento humano y considerado a las interacciones cotidianas. Mi proceso conecta la precisión digital con la ejecución material, llevando los proyectos desde el concepto inicial y el modelado 3D hasta prototipos tangibles y funcionales.",
  },
  // detail
