...
const PROJECTS = [
  ...
  },
  {
    ...
    body: {
      en: "Nido (\u201cnest\u201d) is a family of paper-towel, tissue, and wet-wipe dispensers designed for an elementary-school classroom. Each one takes the shape of a friendly animal, turning a hygiene routine into something kids actually want to do. Rounded, safe edges and intuitive, obvious use—designed to motivate clean hands without a single instruction.\n\nThe Elephant Dispenser highlights this balance of playful semantics and functional modularity. Engineered to accommodate both standard and center-pull toilet paper rolls, it features a versatile internal configuration with three distinct dispensing methods. Beyond offering flexible classroom utility, each orientation changes the visual narrative: a vertical standard roll dispenses from the front to mimic elephant tusks, a center-pull roll dispenses downward like water spraying from a trunk, and a classic horizontal setup offers a familiar, intuitive downward pull.",
      es: "Nido es una familia de dispensadores de toallas de papel, pañuelos y toallitas húmedas diseñada para un salón de primaria. Cada pieza toma la forma de un animal amigable y convierte la rutina de higiene en algo que los niños sí quieren hacer. Bordes redondeados, seguros y de uso intuitivo y evidente: diseñado para motivar manos limpias sin una sola instrucción.\n\nEl Dispensador Elefante resalta este equilibrio entre semántica lúdica y modularidad funcional. Diseñado para alojar tanto rollos de papel higiénico estándar como rollos de extracción central, integra una configuración interna versátil con tres métodos de dispensado distintos. Además de ofrecer utilidad flexible para el salón, cada orientación cambia la narrativa visual: un rollo estándar vertical dispensa desde el frente para imitar los colmillos de un elefante, un rollo de extracción central dispensa hacia abajo como agua saliendo de una trompa, y una configuración horizontal clásica ofrece un gesto familiar e intuitivo de jalar hacia abajo.",
    },
  },
  {
